    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Text(
            'TimeCapsule이 운영하는 YouKids 앱 개인정보 처리 방침',
            style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
          ),
          const Text(
            'YouKids 앱은 개인 정보 보호 법을 준수하며, 관련 법령에 의거한 개인정보처리방침을 정하여 이용자 권익 보호에 최선을 다하고 있습니다. \n회사의 개인 정보 처리 방침은 다음과 같은 내용을 담고 있습니다.',
          ),
          const SizedBox(
            height: 10,
          ),
          ...
          const Text(
              'YouKids앱은 개인정보를 다음 목적 이외의 용도로는 이용하지 않으며 이용 목적 등이 변경될 경우에는 동의를 받아 처리하겠습니다.'),
          const SizedBox(
            height: 10,
          ),
          const Text(
          ...
          const Text('YouKids앱은 다음의 개인정보 항목을 처리하고 있습니다.'),
          const SizedBox(
            height: 5,
          ),
          Table(
            ...
            children: const [
              ...
              TableRow(children: [
                ...
                Padding(
                  padding: EdgeInsets.all(5),
                  child: Text(
                    '사용자 관리, 코스 기능 진행 및 저장, 캡슐 기능 진행 및 저장',
                  ),
                ),
                Padding(
                  padding: EdgeInsets.all(5),
                  child: Text(
                    '필수 : 이메일 주소, 별명, 사용자ID, 프로필 사진',
                  ),
                )
              ]),
              TableRow(children: [
          ...
          const Text(
              'YouKids앱은 개인정보를 “제 1조 개인정보의 처리 목적”과 “제 2조 처리하는 개인정보 항목”에서 고지한 범위 내에서 사용하며, 정보 주체의 사전 동의 없이는 동 범위를 초과하여 이용하거나 원칙적으로 개인정보를 외부에 공개하지 않습니다.'),
          const SizedBox(
            height: 10,
          ),
          const Text(
          ...
          const Text('YouKids앱은 개인정보처리를 따로 위탁하지 않습니다.'),
          const SizedBox(
            height: 10,
          ),
          const Text(
          ...
          const Text(
              '정보 주체는 YouKids앱에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.'),
          const Text(
              '- YouKids앱에 대해 개인정보 보호법 시행령 제41조제1항에 따라 서면, 전화 등을 통하여 하실 수 있으며, YouKids 앱은 이에 대해 지체 없이 조치하겠습니다.'),
          const Text(
          ...
          const Text(
              'YouKids앱은 개인정보 보유 기간의 경과, 처리 목적 달성 등 개인정보가 불필요하게 되었을 때에는 다음과 같이 지체 없이 해당 개인정보를 파기합니다.'),
          const Text('파기 절차 '),
          const Text(
          ...
          const Text(
              'YouKids앱은 「개인정보보호법」 제 29조에 따라 개인정보의 안정성 확보를 위해 다음과 같은 조치를 취하고 있습니다.'),
          const Text('1. 관리적 조치'),
          ...
          const Text(
              'YouKids앱은 개인정보를 보호하고 개인정보와 관련된 사항을 처리하기 위하여 민원을 개인정보 보호 책임자에게 신고하실 수 있습니다.\nYouKids앱은 이용자들의 신고 사항에 대해 신속하게 충분한 답변을 드릴 것입니다.'),
          Table(
            border: TableBorder.all(color: Colors.black),
            children: const [
              TableRow(children: [
          ...
          const Text(
              'YouKids앱은 앱 서비스를 제공하기 위해 ‘클릭 정보’를 수집합니다. 클릭 정보는 웹사이트를 운영하는데 이용되고 서버가 이용자의 앱에 보내는 소량의 정보이며 이용자들의 앱 내에 저장될 수 있습니다.'),
          const Text('- 사용 목적'),
